...
INSERT INTO cat (name, age, gender, follower_cnt, image_url, is_active, tnrdate)
VALUES ('순냥이', '5살', 'MALE', 120, 'https://img.seoul.co.kr//img/upload/2023/04/20/SSC_20230420134023.jpg', 'ACTIVE', '2023-07-20');

INSERT INTO cat (name, age, gender, follower_cnt, image_url, is_active, tnrdate)
VALUES ('도도', '3살', 'MALE', 95, 'https://img.seoul.co.kr//img/upload/2023/04/20/SSC_20230420134023.jpg', 'ACTIVE', '2023-07-20');

INSERT INTO cat (name, age, gender, follower_cnt, image_url, is_active, tnrdate)
VALUES ('티치', '3살', 'MALE', 95, 'https://img.seoul.co.kr//img/upload/2023/04/20/SSC_20230420134023.jpg', 'ACTIVE', '2023-07-20');
...
VALUES
    ...
    (36.7723406404155, 126.93197806444999, '도도 시크하게 생겨가지곤 궁디팡팡 해달라고 빵디 내밈', 'https://velog.velcdn.com/images/ogu1208/post/2cbdc850-373a-4ad1-ab56-31190d4e883c/image.jpg', 101, 1, 1, '2024-04-09 07:00:00'),
    (36.7719167828796, 126.93139878135783, '도도 그루밍', 'https://velog.velcdn.com/images/ogu1208/post/176a46f9-3929-4076-8ca8-03c3a3e0be31/image.jpg', 30, 1, 1, '2024-04-11 10:00:00'),
    ...
    (36.77231682566663, 126.93368906422113, '시험기간에 루루보고 힐링', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjWP0AFIUxwa1qyk55UN0GRrLb55rkMSTIITfq78wJJw&s', 70, 1, 7, '2024-04-17 10:00:00');
